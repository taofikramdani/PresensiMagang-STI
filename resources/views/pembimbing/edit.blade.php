...
@section('title', 'Edit Pembimbing - Presensi Magang')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Data Pembimbing</h1>
                <p class="text-gray-600 mt-1">Ubah data pembimbing: {{ $pembimbing->user->name }}</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-medium text-gray-900">Form Edit Data Pembimbing</h2>
        </div>

        <form action="{{ route('admin.pembimbing.update', $pembimbing) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="username" 
                               id="username" 
                               value="{{ old('username', $pembimbing->user->name) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('jabatan') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="unit_kerja" 
                               id="unit_kerja" 
                               value="{{ old('unit_kerja', $pembimbing->departemen) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('unit_kerja') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="no_hp" 
                               id="no_hp" 
                               value="{{ old('no_hp', $pembimbing->no_telepon) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('no_hp') border-red-500 @enderror"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="alamat" 
                                  ...
                                  placeholder="Alamat lengkap">{{ old('alamat', $pembimbing->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="status" 
                            ...
                            <option value="non_aktif" {{ old('status', $pembimbing->status) === 'non_aktif' ? 'selected' : '' }}>Non Aktif</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
