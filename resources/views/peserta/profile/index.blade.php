...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <h1 class="text-2xl font-bold text-gray-900">{{ $peserta->nama_lengkap }}</h1>
                <p class="text-gray-600">{{ $peserta->nim }} - {{ $peserta->jurusan }}</p>
                <p class="text-sm text-gray-500">{{ $peserta->universitas }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <form action="{{ route('peserta.profile.update') }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama_lengkap" name="nama_lengkap" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('nama_lengkap') border-red-500 @enderror"
                                   required>
                            @error('nama_lengkap')
                        ...
                        <div>
                            <label for="nim" class="block text-sm font-medium text-gray-700 mb-2">
                                NIM/NISN <span class="text-red-500">*</span>
                            </label>
                        ...
                        <div>
                            <label for="universitas" class="block text-sm font-medium text-gray-700 mb-2">
                                Universitas/Sekolah <span class="text-red-500">*</span>
                            </label>
                            <input type="text" id="universitas" name="universitas" 
                                   value="{{ old('universitas', $peserta->universitas) }}"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('universitas') border-red-500 @enderror"
                                   required>
                            @error('universitas')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" id="jurusan" name="jurusan" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('jurusan') border-red-500 @enderror"
                                   required>
                            @error('jurusan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="tel" id="no_telepon" name="no_telepon" 
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('no_telepon') border-red-500 @enderror"
                                   required>
                            @error('no_telepon')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="alamat" name="alamat" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('alamat') border-red-500 @enderror"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Info Magang</h3>
                </div>
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        <div class="text-sm font-medium text-gray-700">Pembimbing</div>
                        <div class="text-sm text-gray-900">
                    ...
                    <div>
                        ...
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                            ...
                            <i class="fas {{ $peserta->status === 'aktif' ? 'fa-check-circle' : 'fa-times-circle' }} mr-1"></i>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <form action="{{ route('peserta.profile.update-password') }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
