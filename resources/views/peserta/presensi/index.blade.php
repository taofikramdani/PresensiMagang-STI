...
@section('content')
    <div class="space-y-4 p-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600">{{ \Carbon\Carbon::now()->locale('id')->isoFormat('dddd, D MMMM Y') }}
                    </p>
                    ...
                    @if($jamKerja)
                        <p class="text-xs text-gray-500 mt-1">
                            <i class="fas fa-clock mr-1"></i>{{ $jamKerja->jam_masuk }} - {{ $jamKerja->jam_keluar }}
                            ({{ $jamKerja->nama_shift }})
                        </p>
                    @endif
                </div>
        ...
        @if($presensiHariIni ?? false)
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div class="grid grid-cols-2 gap-3 mb-3">
                    ...
                    <!-- Check Out -->
                    <div
                        class="flex items-center space-x-2 p-3 {{ $presensiHariIni->jam_keluar ? 'bg-blue-50' : 'bg-gray-50' }} rounded-lg">
                        <div
                            class="w-8 h-8 {{ $presensiHariIni->jam_keluar ? 'bg-blue-500' : 'bg-gray-400' }} rounded-full flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm font-semibold {{ $presensiHariIni->jam_keluar ? 'text-blue-900' : 'text-gray-500' }}">
                ...
                <div class="grid grid-cols-3 gap-2 text-xs">
                    <div class="text-center p-2 bg-gray-50 rounded">
                        ...
                        <p
                            class="font-semibold {{ $presensiHariIni->status === 'hadir' ? 'text-green-600' : ($presensiHariIni->status === 'terlambat' ? 'text-orange-600' : 'text-red-600') }}">
        ...
        <div class="bg-white rounded-xl  p-4">
            ...
            <div id="mapLoading" class="absolute inset-0 bg-gray-100 flex items-center justify-center z-10"
                style="display: none;">
                <div class="text-center">
                    <div
                        class="w-8 h-8 border-4 border-blue-500 border-t-transparent rounded-full animate-spin mx-auto mb-2">
                    </div>
        ...
        <button id="enableGpsBtn" onclick="requestGPSPermission()"
            class="hidden w-full mt-2 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-lg text-sm transition-colors">
    ...
    <!-- Camera Modal -->
    <div id="cameraModal" class="hidden fixed inset-0 bg-gray-500 bg-opacity-50 items-center justify-center p-4"
        style="z-index: 9999;">
